export const lawyerQuestions: string[] = [
  ...
  "Je okamžité zrušení pracovního poměru z 15. 7. 2026 platné, když se většina uváděných jednání (body 1–4 i kontextová část) odehrála v době, kdy jsem byla ještě jednatelkou, nebo dokonce několik týdnů před mým odvoláním (přístupy do e-mailů z 27. 4. a 20. 4. 2026)?",
  "Jaká je lhůta a postup pro žalobu na neplatnost okamžitého zrušení pracovního poměru (§ 72 zákoníku práce) a co všechno bych do ní měla zahrnout?",
  "Zaměstnavatel v okamžitém zrušení tvrdí, že jsem měla k dispozici záložní e-mail amatis.traiva@gmail.com, a proto absence 20 dnů v červnu nebyla překážkou v práci na jeho straně — jak se s tímto novým argumentem vypořádat vůči mému protestu z 14. 7. 2026?",
  "Bod 6 okamžitého zrušení (smazání dat ve schránce j.premus@traiva.cz 21. 4. 2026) zmiňuje možné naplnění § 230 trestního zákoníku a probíhající posouzení trestní odpovědnosti advokátní kanceláří zaměstnavatele — jak se mám na tuto hrozbu připravit a co mám dělat jako první krok?",
  "Zaměstnavatel tvrdí, že jsem přeposlala interní data a finanční výkazy přímo Karlu Neffemu a na e-mail pavelcermak@kb.cz — je rozdíl v posouzení, pokud jsem tyto podklady zpracovávala v rámci due diligence jako jednatelka se souhlasem/vědomím Ospalíka?",
  "Co znamená pro moje dosavadní nároky (přesčasy, odměna jednatelky, mzda za červen 2026), že mi byl pracovní poměr okamžitě zrušen — zanikají, nebo je můžu uplatnit i po skončení PP?"
];
